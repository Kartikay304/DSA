...
Problem Statement: (Fun Game)[https://www.hackerearth.com/practice/data-structures/stacks/basics-of-stacks/practice-problems/algorithm/fun-game-91510e9f/]
...
void game(int arr[],s *ptr,q *qtr1,q *qtr2) {
	while(qtr2->rear>=qtr2->front && qtr1->rear>=qtr1->front) {
